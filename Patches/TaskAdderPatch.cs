...
namespace TownOfHost
{
    ...
    class AddTaskButtonPatch
    {
        private static readonly Dictionary<CustomRoles, RoleTypes> RolePairs = new()
        {
            ...
            { CustomRoles.NeutPoisoner, RoleTypes.Impostor },
            ...
            { CustomRoles.Medic, RoleTypes.Scientist },
            { CustomRoles.SabotageMaster, RoleTypes.Engineer },
         //   { CustomRoles.ScientistRemake, RoleTypes.Scientist },
            { CustomRoles.EngineerRemake, RoleTypes.Engineer },
            { CustomRoles.ShapeshifterRemake, RoleTypes.Shapeshifter },
         //   { CustomRoles.NeutralWitch, RoleTypes.Impostor },
