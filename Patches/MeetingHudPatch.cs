                ...
                foreach (var protect in Main.GuardianAngelTarget)
                {
                    ...
                    if (!ga.Data.IsDead)
                    {
                        if (Options.GAknowsRole.GetBool())
                            Utils.SendMessage("You are a Guardian Angel.\nYou win with yur target.\nYour target's role is: " + Utils.GetRoleName(protecting.GetCustomRole()), ga.PlayerId);
                    }
                ...
                try
                {
                    ...
                    switch (target.GetCustomSubRole())
                    {
                        ...
                        case CustomRoles.TieBreaker:
                            if (seer.Is(CustomRoles.TieBreaker) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.TieBreaker), "★");
                            break;

                        case CustomRoles.Bait:
                            if (seer.Is(CustomRoles.Bait) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Bait), "♦");
                            break;

                        case CustomRoles.Sleuth:
                            if (seer.Is(CustomRoles.Sleuth) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Sleuth), "●");
                            break;

                        case CustomRoles.Watcher:
                            if (seer.Is(CustomRoles.Watcher) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Watcher), "●");
                            break;

                        case CustomRoles.Torch:
                            if (seer.Is(CustomRoles.Torch) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Torch), "●");
                            break;

                        case CustomRoles.Flash:
                            if (seer.Is(CustomRoles.Flash) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Flash), "●");
                            break;

                        case CustomRoles.Escalation:
                            if (seer.Is(CustomRoles.Escalation) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Escalation), "●");
                            break;

                        case CustomRoles.Oblivious:
                            if (seer.Is(CustomRoles.Oblivious) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Oblivious), "●");
                            break;

                        case CustomRoles.Bewilder:
                            if (seer.Is(CustomRoles.Bewilder) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Bewilder), "▲");
                            break;

                        case CustomRoles.Diseased:
                            if (seer.Is(CustomRoles.Diseased) || seer.Data.IsDead)
                                pva.NameText.text += Helpers.ColorString(Utils.GetRoleColor(CustomRoles.Diseased), "▲");
                            break;
                    }
