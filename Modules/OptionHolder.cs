      ...
      //  public static CustomOption EnableGM;
        ...
        public static void Load()
        {
         ...
         //   EnableGM = CustomOption.Create(100, Utils.GetRoleColor(CustomRoles.GM), "GM", false, null, true);
            ...
            // Vanilla Roles
            SetupRoleOptions(9997, CustomRoles.EngineerRemake);
            EngineerVentCooldown = CustomOption.Create(45213, Color.white, "EngineerVentCooldown", 0f, 0f, 180f, 1f, CustomRoleSpawnChances[CustomRoles.EngineerRemake]);
            EngineerVentDuration = CustomOption.Create(45214, Color.white, "EngineerVentDuration", 0f, 0f, 180f, 1f, CustomRoleSpawnChances[CustomRoles.EngineerRemake]);
            //   SetupRoleOptions(9996, CustomRoles.ScientistRemake);
            SetupRoleOptions(9998, CustomRoles.ShapeshifterRemake);
            ShapeshifterCooldown = CustomOption.Create(600125, Color.white, "ShapeshifterCooldown", 10, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.ShapeshifterRemake]);
            ShapeshifterDuration = CustomOption.Create(600135, Color.white, "ShapeshifterDuration", 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.ShapeshifterRemake]);
            ShapeshifterSkin = CustomOption.Create(600145, Color.white, "ShapeshifterSkin", false, CustomRoleSpawnChances[CustomRoles.ShapeshifterRemake]);
         ...
         //   SetupRoleOptions(56969, CustomRoles.NeutralWitch);
        //    ControlCooldown = CustomOption.Create(56970, Color.white, "ControlCooldown", 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.NeutralWitch]);
            ...
            PhantomTasks = OverrideTasksData.Create(40121, CustomRoles.Phantom);
