...
namespace TownOfHost
{
    ...
    public static class Options
    {
        ...
        {
            CustomRoles.Jester.ToString(), CustomRoles.EngineerRemake.ToString(), CustomRoles.Survivor.ToString(), CustomRoles.Madmate.ToString()
        };
        public static readonly CustomRoles[] CRoleGuardianAngelChangeRoles =
        {
            CustomRoles.Jester, CustomRoles.EngineerRemake, CustomRoles.Survivor, CustomRoles.Madmate,
        };
        ...
        public static CustomOption PuppeteerCooldown;
        ...
        //    "SuffixMode.EssName",
       //     "SuffixMode.EssTag",
        //    "SuffixMode.ShiftyName",
        //    "SuffixMode.ShiftyTag",
        //    "SuffixMode.LoonieName",
         //   "SuffixMode.LoonieTag",
          //  "SuffixMode.Host"
            //"SuffixMode.Dev"
        };
        ...
        public static void Load()
        {
            ...
            // Vanilla Roles
            SetupRoleOptions(9997, CustomRoles.EngineerRemake, AmongUsExtensions.OptionType.Crewmate);
            EngineerVentCooldown = CustomOption.Create(45213, Color.white, "EngineerVentCooldown", AmongUsExtensions.OptionType.Crewmate, 0f, 0f, 180f, 1f, CustomRoleSpawnChances[CustomRoles.EngineerRemake]);
            EngineerVentDuration = CustomOption.Create(45214, Color.white, "EngineerVentDuration", AmongUsExtensions.OptionType.Crewmate, 0f, 0f, 180f, 1f, CustomRoleSpawnChances[CustomRoles.EngineerRemake]);
            SetupRoleOptions(9995, CustomRoles.Physicist, AmongUsExtensions.OptionType.Crewmate);
            //    ScientistVitalsCooldown = CustomOption.Create(45213, Color.white, "ScientistVitalsCooldown", AmongUsExtensions.OptionType.Crewmate, 0f, 0f, 180f, 1f, CustomRoleSpawnChances[CustomRoles.Physicist]);
            //    ScientistVitalsDuration = CustomOption.Create(45214, Color.white, "ScientistVitalsDuration", AmongUsExtensions.OptionType.Crewmate, 0f, 0f, 180f, 1f, CustomRoleSpawnChances[CustomRoles.Physicist]);
            //   SetupRoleOptions(9996, CustomRoles.ScientistRemake);
            SetupRoleOptions(9998, CustomRoles.ShapeshifterRemake, AmongUsExtensions.OptionType.Impostor);
            ShapeshifterCooldown = CustomOption.Create(600125, Color.white, "ShapeshifterCooldown", AmongUsExtensions.OptionType.Impostor, 10, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.ShapeshifterRemake]);
            ShapeshifterDuration = CustomOption.Create(600135, Color.white, "ShapeshifterDuration", AmongUsExtensions.OptionType.Impostor, 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.ShapeshifterRemake]);
            ShapeshifterSkin = CustomOption.Create(600145, Color.white, "ShapeshifterSkin", AmongUsExtensions.OptionType.Impostor, false, CustomRoleSpawnChances[CustomRoles.ShapeshifterRemake]);
            ...
            //   SetupRoleOptions(1214692, CustomRoles.Alturist, AmongUsExtensions.OptionType.Crewmate);
            ...
            ArsoImpVision = CustomOption.Create(50513, Color.white, "ArsoImpVision", AmongUsExtensions.OptionType.Neutral, false, CustomRoleSpawnChances[CustomRoles.Arsonist]);
            ...
            SetupSingleRoleOptions(509699, CustomRoles.Opportunist, 1, AmongUsExtensions.OptionType.Neutral);
            ...
            SetupSingleRoleOptions(50713, CustomRoles.NeutPoisoner, 1, AmongUsExtensions.OptionType.Neutral);
            PoisonCooldown = CustomOption.Create(50714, Color.white, "PoisonCooldown", AmongUsExtensions.OptionType.Neutral, 30, 2.5f, 180, 2.5f, CustomRoleSpawnChances[CustomRoles.NeutPoisoner]);
            PoisonDelay = CustomOption.Create(50715, Color.white, "PoisonDelay", AmongUsExtensions.OptionType.Neutral, 5, 1, 1000, 1, CustomRoleSpawnChances[CustomRoles.NeutPoisoner]);
            PoisonerBuff = CustomOption.Create(1311, Color.white, "PoisonerBuff", AmongUsExtensions.OptionType.Neutral, true, CustomRoleSpawnChances[CustomRoles.NeutPoisoner]);
            ...
            .SetGameMode(CustomGameMode.All);
            RolesLikeToU = CustomOption.Create(102001, Color.white, "RolesLikeToU", AmongUsExtensions.OptionType.GameOption, false, null, true)
            .SetGameMode(CustomGameMode.All);
